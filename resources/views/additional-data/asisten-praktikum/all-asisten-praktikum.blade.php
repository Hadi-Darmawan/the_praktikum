...
@section('title', 'Additional Data | Asisten Praktikum')
        ...
        <div class="col-auto ml-auto text-right mt-n1 my-auto">
            <nav aria-label="breadcrumb text-center">
                <ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Asisten praktikum</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="col-12 p-0">
                <div class="card">
                    <div class="card-header">
                        <p class="text-md-start text-center my-auto">Daftar Data Asisten Praktikum</p>
                    </div>
